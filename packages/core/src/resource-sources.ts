...
export const RESOURCE_SOURCES: ResourceSourceSeed[] = [
  ...
  { code: 'REGISTRATION', name: 'State Registration and Stamps Departments (IGR)', publisher: 'State Inspector General of Registration departments', baseUrl: 'https://ngdrs.gov.in/', trustLevel: 2, category: 'state_government', rightsNote: 'Sale deed, gift deed and tenancy registration portals of individual states. The specific department is named on each resource. Linked only — reachability verified per entry, dated 2026-08-21; several sites block automated fetches from data-centre IP ranges even when reachable from an ordinary browser, and are marked accordingly.' },

  // ---- e-stamping ----------------------------------------------------------
  { code: 'SHCIL', name: 'Stock Holding Corporation of India — e-Stamping', publisher: 'Stock Holding Corporation of India Ltd (Central Record Keeping Agency)', baseUrl: 'https://www.shcilestamp.com/', trustLevel: 1, category: 'central_government', rightsNote: 'The Reserve Bank of India-appointed Central Record Keeping Agency for e-stamping under the Indian Stamp Act, 1899, operating in the states that have adopted e-stamping. Linked only — this platform never issues or resells stamp paper.' },
  { code: 'NGDRS_SOURCE', name: 'National Generic Document Registration System', publisher: 'Department of Land Resources, Ministry of Rural Development', baseUrl: 'https://ngdrs.gov.in/', trustLevel: 1, category: 'central_government', rightsNote: 'The shared central platform a subset of states have adopted for document registration; states not on NGDRS run their own portal instead. Linked only.' },
];
